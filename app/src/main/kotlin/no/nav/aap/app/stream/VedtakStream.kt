...
internal fun StreamsBuilder.vedtakStream(mottakerKtable: KTable<String, MottakereKafkaDtoHistorikk>) {
...
private val håndter =
    { ident: String, kafkaDto: IverksettVedtakKafkaDto, mottakerKafkaDtoHistorikk: MottakereKafkaDtoHistorikk? ->
        val mottakerModellApi = mottakerKafkaDtoHistorikk?.mottakereKafkaDto?.toModellApi()
            ?: MottakerModellApi.opprettMottaker(ident, kafkaDto.fødselsdato)
        ...
        endretDtoMottaker.toMottakereKafkaDtoHistorikk(mottakerKafkaDtoHistorikk?.sekvensnummer ?: 0)
    }
